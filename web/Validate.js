    ...
    switch (objState.value) {
        case "Kerala":
            ...
            for (i = 0; i < kerala.length; i++) {
                objCity.options.add(new Option(kerala[i]));
            }
            break;
        case "Tamil Nadu":
            ...
            for (i = 0; i < tn.length; i++) {
                objCity.options.add(new Option(tn[i]));
            }
            break;
        default:
            objCity.options.add(new Option("Select"));
